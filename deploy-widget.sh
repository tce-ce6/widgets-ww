#!/usr/bin/env bash
# ==============================================================================
# deploy-widget.sh  —  Deploy your widget folder to Firebase Hosting
# ==============================================================================
# Run this from your own branch to publish a single widget.
# It updates the listing page automatically and deploys everything.
#
# Usage:
...
unset _SCRIPT_JS _WIDGET_TITLE _WIDGET_URL _ASSET_PATH _WG_NUM \
      _WIDGET_FOLDER _CREATOR_INITIALS _WIDGET_STATUS _HOSTING_SITE
