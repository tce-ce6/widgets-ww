...
window.Wg146 = {
    ...
    cacheDOMElements: function () {
        ...
        // Inject Lottie exactly over the portrait grouping via SVG mapping
        if (!document.getElementById("fo-lottie") && this.UI.imagesGroup && window.lottie) {
            const fo = document.createElementNS("http://www.w3.org/2000/svg", "foreignObject");
            fo.setAttribute("x", "0");
            fo.setAttribute("y", "156");
            fo.setAttribute("width", "611");
            fo.setAttribute("height", "739");
            ...
            div.style.display = "none"; // CSS hides naturally, but explicitly
            div.style.width = "100%";
            div.style.height = "100%";
            div.style.overflow = "visible";
            fo.appendChild(div);

            this.UI.imagesGroup.appendChild(fo);
    ...
    hideAll: function () {
        ...
        if (this.lottieAnim) this.lottieAnim.stop();
    ...
    handleOptionClick: function (btn) {
        ...
        if (selectedOption === author.correct) {
            ...
            if (lw) {
                ...
                if (this.lottieAnim) this.lottieAnim.goToAndPlay(0, true);
            }
