document.addEventListener("DOMContentLoaded", () => {
    ...
    const sepoysBtn = document.getElementById("sepoys");
    const regionalLeadersBtn = document.getElementById("the-regional-leaders");
    ...
    sepoysBtn.addEventListener("click", () => {
        selectRegion("Sepoys Revolt", "sepoys");
    });

    regionalLeadersBtn.addEventListener("click", () => {
        selectRegion("Regional Leaders", "regional_leaders");
    });
