document.addEventListener("DOMContentLoaded", () => {
  ...
  const config = {
    ...
    substances: {
      lemon_juice: {
        ...
        btnId: "btn-lemon-juice",
        labelId: "label-lemon-juice",
        animation: "assets/animation/lemon_juice.json",
        ph: 2,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Lemon Juice</tspan> is a <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
      ...
      vinegar: {
        displayName: "Vinegar",
        btnId: "btn-vinegar",
        labelId: "label-vinegar",
        animation: "assets/animation/vinegar.json",
        ph: 2.4,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Vinegar</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 2.4</tspan></tspan>",
        },
      },
      milk: {
        displayName: "Milk",
        btnId: "btn-milk",
        labelId: "label-milk",
        animation: "assets/animation/milk.json",
        ph: 6.5,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Milk</tspan> is <tspan font-weight='bold'>SLIGHTLY ACIDIC</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 6.5</tspan></tspan>",
        },
      },
      baking_soda: {
        displayName: "Baking Soda",
        btnId: "btn-baking-soda",
        labelId: "label-baking-soda",
        animation: "assets/animation/baking_soda.json",
        ph: 8.3,
        nature: "BASE",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Baking Soda</tspan> is a <tspan font-weight='bold'>BASE</tspan></tspan>",
          phText:
      ...
      coffee: {
        displayName: "Coffee",
        btnId: "btn-coffee",
        labelId: "label-coffee",
        animation: "assets/animation/coffee.json",
        ph: 5,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Coffee</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 5</tspan></tspan>",
        },
      },
      orange_juice: {
        displayName: "Orange Juice",
        btnId: "btn-orange-juice",
        labelId: "label-orange-juice",
        animation: "assets/animation/orange_juice.json",
        ph: 3.5,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Orange Juice</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 3.5</tspan></tspan>",
        },
      },
      sugar_solution: {
        displayName: "Sugar Solution",
        btnId: "btn-sugar-solution",
        labelId: "label-sugar-solution",
        animation: "assets/animation/sugar_solution.json",
        ph: 7,
        nature: "NEUTRAL",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Sugar Solution</tspan> is <tspan font-weight='bold'>NEUTRAL</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 7</tspan></tspan>",
        },
      },
      salt_solution: {
        displayName: "Salt Solution",
        btnId: "btn-salt-solution",
        labelId: "label-salt-solution",
        animation: "assets/animation/salt_solution.json",
        ph: 7,
        nature: "NEUTRAL",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Salt Solution</tspan> is <tspan font-weight='bold'>NEUTRAL</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 7</tspan></tspan>",
        },
      },
      soap_solution: {
        displayName: "Soap Solution",
        btnId: "btn-soap-solution",
        labelId: "label-soap-solution",
        animation: "assets/animation/soap_solution.json",
        ph: 12,
        nature: "BASE",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Soap Solution</tspan> is a <tspan font-weight='bold'>BASE</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 12</tspan></tspan>",
        },
      },
      pure_water: {
        displayName: "Pure Water",
        btnId: "btn-pure-water",
        labelId: "label-pure-water",
        animation: "assets/animation/pure_water.json",
        ph: 7,
        nature: "NEUTRAL",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Pure Water</tspan> is <tspan font-weight='bold'>NEUTRAL</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 7</tspan></tspan>",
        },
      },
      bleach_solution: {
        ...
        btnId: "btn-bleach-solution",
        labelId: "label-bleach-solution",
        animation: "assets/animation/bleach_solution.json",
        ph: 12.5,
        nature: "BASE",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Bleach Solution</tspan> is a <tspan font-weight='bold'>STRONG BASE</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 12.5</tspan></tspan>",
        },
      },
      tamarind_pulp: {
        displayName: "Tamarind Pulp",
        btnId: "btn-tamarind-pulp",
        labelId: "label-tamarind-pulp",
        animation: "assets/animation/tamarind_pulp.json",
        ph: 3,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Tamarind Pulp</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
      ...
      butter_milk: {
        ...
        btnId: "btn-butter-milk",
        labelId: "label-butter-milk",
        animation: "assets/animation/butter_milk.json",
        ph: 4.5,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Buttermilk</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
      ...
      tomato_juice: {
        ...
        btnId: "btn-tomato-juice",
        labelId: "label-Tomato-juice",
        animation: "assets/animation/tomato_juice.json",
        ph: 4.2,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Tomato Juice</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
      ...
      stomach_acid: {
        ...
        btnId: "btn-stomach-acid",
        labelId: "label-stomach-acid",
        animation: "assets/animation/stomach_acid.json",
        ph: 1.5,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Stomach Acid</tspan> is a <tspan font-weight='bold'>STRONG ACID</tspan></tspan>",
          phText:
      ...
      blood_sample: {
        ...
        btnId: "btn-blood-sample",
        labelId: "label-blood-sample",
        animation: "assets/animation/blood_sample.json",
        ph: 7.4,
        nature: "BASE",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Blood Sample</tspan> is <tspan font-weight='bold'>SLIGHTLY BASIC</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 7.4</tspan></tspan>",
        },
      },
      ammonia_solution: {
        displayName: "Ammonia Solution",
        btnId: "btn-ammonia-solution",
        labelId: "label-ammonia-solution",
        animation: "assets/animation/ammonia_solution.json",
        ph: 11,
        nature: "BASE",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Ammonia Solution</tspan> is a <tspan font-weight='bold'>BASE</tspan></tspan>",
          phText:
      ...
      cola: {
        ...
        btnId: "btn-cola",
        labelId: "label-cola",
        animation: "assets/animation/cola.json",
        ph: 2.5,
        nature: "ACID",
        feedback: {
          labelText:
            "<tspan><tspan font-weight='bold'>Cola</tspan> is an <tspan font-weight='bold'>ACID</tspan></tspan>",
          phText:
            "<tspan>pH Value:<tspan font-weight='bold'> 2.5</tspan></tspan>",
        },
      },
    },
  };
  ...
  const els = {
    ...
    btnNextIncorrect: document.getElementById(
      config.controls.incorrectNextButton
    ),
  ...
  function setupFeedbackTextElements() {
    ...
    els.correctLabelText = createTextEl(
      "correct-label-text",
      config.feedbackLayout.correct.labelText.x,
      config.feedbackLayout.correct.labelText.y,
      "correct-feedback"
    );
    els.correctPhText = createTextEl(
      "correct-ph-text",
      config.feedbackLayout.correct.phText.x,
      config.feedbackLayout.correct.phText.y,
      "correct-feedback"
    );

    // Create Incorrect Feedback Elements
    els.incorrectLabelText = createTextEl(
      "incorrect-label-text",
      config.feedbackLayout.incorrect.labelText.x,
      config.feedbackLayout.incorrect.labelText.y,
      "incorrect-feedback"
    );
    els.incorrectPhText = createTextEl(
      "incorrect-ph-text",
      config.feedbackLayout.incorrect.phText.x,
      config.feedbackLayout.incorrect.phText.y,
      "incorrect-feedback"
    );

    // Create Nature Info Elements (Optional, based on coordinates in logic)
    els.correctNatureText = createTextEl(
      "correct-nature-info-text",
      config.feedbackLayout.correct.natureText.x,
      config.feedbackLayout.correct.natureText.y,
      "correct-feedback"
    );
    els.incorrectNatureText = createTextEl(
      "incorrect-nature-info-text",
      config.feedbackLayout.incorrect.natureText.x,
      config.feedbackLayout.incorrect.natureText.y,
      "incorrect-feedback"
    );
  }
  ...
  function setupEventListeners() {
    ...
    Object.keys(config.substances).forEach((key) => {
      ...
      if (btn) {
        ...
        btn.addEventListener("click", () => {
          ...
          if (
            state.completedSubstances.has(key) ||
            state.isAnimating ||
            state.phSelected
          )
            return;
    ...
    // Next Buttons
    els.btnNextCorrect.addEventListener("click", ()=>{
        restorePhControlsPointerEvents();
        restorePointerEventsForLastLiquid();
        resetUI();
    });
  ...
  function handleLiquidSelection(key) {
    ...
    if (
      state.selectedLiquidKey &&
      !state.completedSubstances.has(state.selectedLiquidKey)
    ) {
      const prevBtn = document.getElementById(
        config.substances[state.selectedLiquidKey].btnId
      );
  ...
  function evaluateResult() {
    ...
    if (substance.nature.includes(state.selectedNature)) {
      ...
      state.selectedNature === "NEUTRAL" &&
      substance.nature === "NEUTRAL"
    ) {
      isCorrect = true;
    }
  ...
  function disablePhControlsAfterCorrect() {
    const ids = ["btn-acid", "btn-neutral", "btn-base", "btn-test-ph-paper"];
...
function restorePointerEventsForLastLiquid() {
  if (!state.selectedLiquidKey) return;

  const btnId = config.substances[state.selectedLiquidKey].btnId;
  const btn = document.getElementById(btnId);

  if (btn) {
    btn.style.pointerEvents = ''; // remove inline override
  }
}
function restorePhControlsPointerEvents() {
  const ids = [
    "btn-neutral",
    "btn-acid",
    "btn-base",
  ...
  ids.forEach(id => {
    const el = document.getElementById(id);
    if (el) {
      el.style.pointerEvents = ""; // removes inline `none`
    }
  });
}
